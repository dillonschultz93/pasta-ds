...
UID: P0000 # "PN" = Pattern + Hexa code/index
...
# Pattern Template `{{ page.project_id }}-{{ page.UID }}`
{: .no_toc}
...
| UID | Ticket | Owner |
|---|---|---|
| `{{ page.project_id }}-{{ page.UID }}`| [Gihtub Issue &#35;2](https://github.com/yummly/pasta/issues/2) | [Robert](https://github.com/robert-ANML) |
...
|↓ Are impacted| idle | over | pressed | disabled | focused | pending |
|---|---|---|---|---|---|---|
...
|↓ Are impacted|Theme &#35;1 |Theme &#35;2|Theme &#35;3|
|---|---|---|
| Attribute &#35;1|`token`|`token`|`token`|
| Attribute &#35;2|`token`|`token`|`token`|
...
|---|---|---|
|[1.1.1](https://www.w3.org/TR/WCAG21/#text-alternatives)|<input type="checkbox" class="checklistItem" checked>|Text Alternatives|
| [1.4.1](https://www.w3.org/TR/WCAG21/#use-of-color) | <input type="checkbox" class="checklistItem" checked> | Color not the only way to convey information 1.4.1 |
|[1.4.3](https://www.w3.org/TR/WCAG21/#contrast-minimum)|<input type="checkbox" class="checklistItem" checked>|Text Color Contrast|
|[1.4.6](https://www.w3.org/TR/WCAG21/#contrast-enhanced)|<input type="checkbox" class="checklistItem" checked>|Text Color Contrast|
|[1.4.11](https://www.w3.org/TR/WCAG21/#non-text-contrast)|<input type="checkbox" class="checklistItem" checked>|Color Contrast|
|[1.4.4](https://www.w3.org/TR/WCAG21/#resize-text)|<input type="checkbox" class="checklistItem" checked>|200% Text Size|
|[1.4.12](https://www.w3.org/TR/WCAG21/#text-spacing)|<input type="checkbox" class="checklistItem" checked>|Text Spacing|
{: .type-01}
...
<table>
    <tbody>
      ...
      <tr>
          <td>
            <input type="checkbox" class="checklistItem" checked><strong>Accessible contrast for text</strong><br>Text has a contrast ratio of at least 4.5:1 for small text and at least 3:1 for large text (WCAG 2.1-1.4.3 and 1.4.6).
          </td>
          <td>
