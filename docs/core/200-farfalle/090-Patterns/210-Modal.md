...
permalink: farfalle/patterns/modal-P000C # lowercase + use hyphens › https://tinyurl.com/27kmc4rb
...
<p>
  Modal display a list of choices on a temporary surface.
</p>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>001</code></td>
      <td>Modal</td>
      <td>Includes page header context for the user and a container to build views.</td>
    </tr>
  </tbody>
</table>
