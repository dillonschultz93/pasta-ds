...
permalink: farfalle/patterns/flash-card-P0007 # lowercase + use hyphens › https://tinyurl.com/27kmc4rb
...
<p>
  Flash cards contain content and actions that relate information about a subject.
</p>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>-001</code></td>
      <td>Flash Cards with Interaction</td>
      <td>Used as a container that contains text and a text button.</td>
    </tr>
  </tbody>
</table>
